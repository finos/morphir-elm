                                        ...
                                        nextCondition :: restOfConditions ->
                                            case nextCondition of
                                                BoolCondition cond ->
                                                    ...
                                                    in
                                                    case Interpreter.evaluateValue False SDK.nativeFunctions ir variables [] rawCriterion of
                                                ...
                                                PatternCondition cond ->
                                                    let
                                                        ...
                                                        evaluatedSubject =
                                                            case Interpreter.evaluateValue False SDK.nativeFunctions ir variables [] rawSubject of
                                                                Ok result ->
                                                                    result
